...
VALUES (
  ...
  'Lebensmittel S1',
  100.00,
  '11111111-1111-1111-1111-000000000001',  -- Jannik
  'equal'
);
...
WHERE s.transaction_id = '99999999-0000-0000-0000-000000000001'
...
FROM v_transaction_shares s
JOIN persons p ON p.id = s.person_id
WHERE s.transaction_id = '99999999-0000-0000-0000-000000000004'
...
FROM v_transaction_shares s
JOIN persons p ON p.id = s.person_id
WHERE s.transaction_id = '99999999-0000-0000-0000-000000000003'
ORDER BY share DESC, p.display_name;
...
UPDATE trip_members
 ...
 WHERE trip_id = '22222222-2222-2222-2222-000000000001'
   AND person_id = '11111111-1111-1111-1111-000000000006';
...
INSERT INTO transactions (id, trip_id, type, date, description, amount, paid_by, split_type) VALUES
  ('99999999-0000-0000-0000-000000000007',
   ...
   '11111111-1111-1111-1111-000000000001', 'equal'),
  ('99999999-0000-0000-0000-000000000008',
   '22222222-2222-2222-2222-000000000001',
   'expense', '2026-04-07', 'S7-Test 150€', 150.00,
   '11111111-1111-1111-1111-000000000005', 'on_board');
