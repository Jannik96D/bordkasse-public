...
DECLARE
  -- Personen
  p_jannik  UUID := '11111111-1111-4111-8111-000000000001';
  p_lucas   UUID := '11111111-1111-4111-8111-000000000002';
  p_dario   UUID := '11111111-1111-4111-8111-000000000003';
  p_tim    UUID := '11111111-1111-4111-8111-000000000004';
  p_emma    UUID := '11111111-1111-4111-8111-000000000005';
  p_stephan UUID := '11111111-1111-4111-8111-000000000006';
  p_peter   UUID := '11111111-1111-4111-8111-000000000007';
  p_harald  UUID := '11111111-1111-4111-8111-000000000008';
  p_tia     UUID := '11111111-1111-4111-8111-000000000009';
  p_ida     UUID := '11111111-1111-4111-8111-00000000000a';

  -- Trip
  trip_test UUID := '22222222-2222-4222-8222-000000000001';

  -- Kategorien
  cat_lebensmittel UUID := '33333333-3333-4333-8333-000000000001';
  cat_restaurant   UUID := '33333333-3333-4333-8333-000000000002';
  cat_sprit        UUID := '33333333-3333-4333-8333-000000000003';
  cat_yacht        UUID := '33333333-3333-4333-8333-000000000004';
  cat_ausruestung  UUID := '33333333-3333-4333-8333-000000000005';
BEGIN
  -- ── Personen ─────────────────────────────────────────────────────────
