-- ═══════════════════════════════════════════════════════════════════════
-- 0015 — Views für "Pro Person" + Trinkgeld (Teil 2/2 von 0014)
--
-- Muss in separater Migration laufen, weil der Enum-Wert 'per_person' aus
-- 0014 erst committed sein muss bevor er in CASE-Statements referenziert
-- werden darf (Postgres "unsafe use of new value" — Fehler 55P04).
-- ═══════════════════════════════════════════════════════════════════════

-- ── v_transaction_shares mit per_person + tip ────────────────────────
...
-- ── v_balances: paid_per inkl. Trinkgeld ─────────────────────────────
