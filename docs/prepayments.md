...
prepayment_tranches
  id                UUID PK
  trip_id           UUID REFERENCES trips(id) ON DELETE CASCADE
  due_date          DATE          -- Charterfrist gegenüber der Agentur (Crewfrist = due_date − 3 Tage)
